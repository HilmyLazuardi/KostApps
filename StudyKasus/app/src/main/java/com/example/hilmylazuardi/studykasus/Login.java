...
public class Login extends AppCompatActivity {
    ...
    Button btn_login;
    TextView buat_akun;
    TextInputEditText user_login, pass_login;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_login = (TextInputEditText) findViewById(R.id.user_login);
        pass_login = (TextInputEditText) findViewById(R.id.pass_login);
        buat_akun = (TextView) findViewById(R.id.tv_register);
